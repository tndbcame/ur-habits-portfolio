...
//     return await firestoreRepository.checkUserExists(userId);
//   }

//   /// パートナーが存在するか確認する
//   Future<int> checkPartnerExists(String userId) async {
//     return await firestoreRepository.checkPartnerExists(userId);
//   }

//   /// ユーザー名を取得する
//   Future<String> getUsername(String userId) async {
//     return await firestoreRepository.getUserName(userId);
//   }

//   /// ユーザー名を更新する
//   Future<void> setUserInfo(String userId, String username, String email) async {
//     firestoreRepository.setUserInfo(userId, username, email);
//   }

//   /// ユーザー名を更新する
//   Future<void> updateMyname(String userId, String newUsername) async {
//     await firestoreRepository.updateUsername(userId, newUsername);
//   }

//   /// パートナー名を取得する
//   Future<String> getPartnername(String userId) async {
//     String partnerName = '';
//     final partnerNames = await firestoreRepository.getPartnerNames(userId);
...
//     return await firestoreRepository.getPartnerInfos(userId);
//   }

//   /// パートナーの名前を更新する
//   Future<void> updatePartnername(
//       String userId, String partnerId, String newUsername) async {
//     await firestoreRepository.updatePartnername(partnerId, userId, newUsername);
//   }
...
//     if (!await firestoreRepository.sentRequestExist(myId, partnerId)) {
//       await firestoreRepository.setSentRequest(
//           myId, partnerId, partnerUsername);
//     }
//     if (!await firestoreRepository.gotRequestExist(myId, partnerId)) {
//       await firestoreRepository.setGotRequest(myId, partnerId, myUsername);
//     }
//   }
...
//     //自分側
//     await firestoreRepository.setPartner(myId, partnerId, partnerName);
//     await _removePartnerRequests(myId, partnerId);
//     //相手側
//     await firestoreRepository.setPartner(partnerId, myId, myName);
...
//     //自分側
//     await firestoreRepository.deletePartner(partnerId, myId);
//     //相手側
//     await firestoreRepository.deletePartner(myId, partnerId);
//   }

//   /// パートナーリクエストを削除する
//   Future<void> deletePartnerRequests(String myId, String partnerId) async {
//     firestoreRepository.deleteSentRequest(partnerId, myId);
//     firestoreRepository.deleteGotRequest(partnerId, myId);
//   }

//   /// ユーザーの習慣を取得する
//   Future<List<HabitView>> getHabits(String userId) async {
//     final habitsData = await firestoreRepository.getHabits(userId);
//     return habitsData.map(_createHabitView).toList();
//   }

//   /// パートナーの習慣を取得する
//   Future<List<HabitView>> getPartnerHabits(
//       List<QueryDocumentSnapshot<Map<String, dynamic>>> docs) async {
//     final habitsData = await Future.wait(docs.map((doc) async {
//       final habitData = doc.data();
//       final recordsData =
//           await firestoreRepository.getHabitRecords(doc.reference);
...
//     //自分側
//     if (await firestoreRepository.sentRequestExist(myId, partnerId)) {
//       firestoreRepository.deleteSentRequest(myId, partnerId);
//     }
//     //相手側
//     if (await firestoreRepository.gotRequestExist(myId, partnerId)) {
//       firestoreRepository.deleteGotRequest(myId, partnerId);
//     }
//   }
...
//         ?.map((record) {
//           final date = HabitConverter.toDate(record['date']);
//           if (date == null) return null;
//           return HabitConverter.toRecordMap(
//             date,
