...
| 円グラフを表示しないで目標値のみを表示する画面です。              | アプリの設定画面です。テーマカラーの変更やアカウント関係の情報の設定をすることができます。                          |
...
| アプリのタイトル画面です。ログインや新規アカウント作成を選択できる画面となっています。                 | アカウントを新規で作成することができる画面です。           |
...
| 作成したアカウントを用いてログインができる画面です。               | このアプリのチュートリアルを表示することができる画面となっています。                                          |
...
今後はパートナーの登録数や公開できる習慣数を増やすなど、機能の拡張をしていけたらと思います。またmodelやview_modelは冗長な部分が多いため、リファクタやライブラリを導入して、管理しやすい拡張性のあるアプリにしていきたいと思います。